...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground ,color_ruby))))
   ...
   `(font-lock-type-face ((,class (:foreground ,color_raw_umber))))
   `(font-lock-constant-face ((,class (:foreground ,color_ink_blue))))
   ...
   `(org-level-1               ((,class :weight bold :foreground ,color_carrot_orange :height 1.8)))
   `(org-level-2               ((,class :weight bold :foreground ,color_carrot_orange :height 1.4)))
   `(org-level-3               ((,class :weight bold :foreground ,color_pannsy :height 1.2)))
   `(org-level-4               ((,class :weight bold :foreground ,color_pannsy)))
   `(org-level-5               ((,class :weight bold :foreground ,color_teal_green)))
   `(org-level-6               ((,class :weight bold :foreground ,color_teal_green)))
   `(org-level-7               ((,class :weight bold :foreground ,color_olive_drab)))
   `(org-level-8               ((,class :weight bold :foreground ,color_olive_drab)))
   `(org-level-9               ((,class :weight bold :foreground ,color_olive_drab)))
   `(org-level-10              ((,class :weight bold :foreground ,color_olive_drab)))
