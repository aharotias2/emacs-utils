...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(line-number ((t (:foreground ,color-spinach-green :background ,color-ice-green))))
   `(line-number-current-line ((t (:inherit line-number :foreground ,color-meadow-green))))
   ;; Mode line faces
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground ,color-ruby))))
   `(font-lock-keyword-face ((,class (:weight bold :foreground ,color-oriental-blue))))
   `(font-lock-comment-face ((,class (:slant italic :foreground "rosybrown"))))
   `(font-lock-string-face ((,class (:foreground ,color-olive-green :background "#E0E4E4"))))
   `(font-lock-function-name-face ((,class (:foreground "olivedrab" :weight bold))))
   `(font-lock-type-face ((,class (:foreground ,color-raw-umber))))
   `(font-lock-constant-face ((,class (:foreground ,color-ink-blue))))
   ...
   `(org-level-1               ((,class :weight bold :foreground ,color-carrot-orange :height 1.8)))
   `(org-level-2               ((,class :weight bold :foreground ,color-carrot-orange :height 1.4)))
   `(org-level-3               ((,class :weight bold :foreground ,color-pannsy :height 1.2)))
   `(org-level-4               ((,class :weight bold :foreground ,color-pannsy)))
   `(org-level-5               ((,class :weight bold :foreground ,color-teal-green)))
   `(org-level-6               ((,class :weight bold :foreground ,color-teal-green)))
   `(org-level-7               ((,class :weight bold :foreground ,color-olive-drab)))
   `(org-level-8               ((,class :weight bold :foreground ,color-olive-drab)))
   `(org-level-9               ((,class :weight bold :foreground ,color-olive-drab)))
   `(org-level-10              ((,class :weight bold :foreground ,color-olive-drab)))
